...
public class DeleteFeedbackServlet extends HttpServlet {
        ...
        try {
            if (feedbackID != null) {
                if (deleteFeedback(feedbackID)) {
                    request.setAttribute("SUCCESS", "Xoá feedback thành công");
                } else {
                    request.setAttribute("ERROR", "Xoá feedback thất bại");
                }
            }
    ...
    private boolean deleteFeedback(String feedbackID) throws SQLException, ClassNotFoundException {

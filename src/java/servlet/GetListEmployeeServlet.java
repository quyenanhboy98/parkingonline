 ...
 * @author Yuu
 */
@WebServlet(name = "GetListEmployeeServlet", urlPatterns = {"/GetListEmployeeServlet"})
public class GetListEmployeeServlet extends HttpServlet {

    private static String page = "GetListParkForEmployeeServlet";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (parkID != null && parkID.isEmpty()) parkID = null;
            List<EmployeeDTO> list = getListEmployee(parkID);            
            request.setAttribute("LISTEMPLOYEE", list);
            if (list == null) {
                request.setAttribute("LISTEMPTY", "Danh sách nhân viên rỗng.");
            }

 ...
 * @author Yuu
 */
@WebServlet(name = "GetListParkForFeedbackServlet", urlPatterns = {"/GetListParkForFeedbackServlet"})
public class GetListParkForFeedbackServlet extends HttpServlet {
...
//    private static String page = "listworkingschedule.jsp";
     ...
     */
    private final String addFeedback = "addfeedback.jsp";
    
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {
        response.setContentType("text/html;charset=UTF-8");
        String url = addFeedback;
        try {

 ...
 * @author Yuu
 */
@WebServlet(name = "ChangeActiveEmployeeServlet", urlPatterns = {"/ChangeActiveEmployeeServlet"})
public class ChangeActiveEmployeeServlet extends HttpServlet {

    private static String page = "SearchEmployeeServlet";

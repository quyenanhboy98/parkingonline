...
<html lang="en">
    ...
    <head>
        ...
        <link rel="stylesheet" href="assets/stylesheets/addworkingtime.css" />
    ...
    <body on>
        ...
        <c:if test="${not empty requestScope.SUCCESS}">
            <div id="myModal" class="modal">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        <input type="button" class="btn btn-default" value="ĐÓNG" id="input-close" onclick="location.href = 'GetListWorkingSchedule?srcPage=workingtime.jsp&parkID=${param.parkID}'"/>
                    </div>
                </div>
            </div>
        </c:if>
        ...
        <div id="containner" class="col-md-12" style="margin-top: 20px;">
            ...
            <h1 style="margin-left: 25px; color: #0074ad">THÊM CA LÀM VIỆC</h1>
            ...
            <div class="col-md-5">
                ...
                <form action="addWorkingTime" onsubmit="preAdd()">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="input-group col-md-12">
                            <input id="workingTimeID" class="col-md-12 form-control" value="${requestScope.WKTIDNEW}" readonly="readonly" type="text"
                                   name="workingTimeID" />
                        </div>
                    ...
                    <div class="col-md-4" style="margin-top: 20px">
                        ...
                        <input style="width: 120px; height: 45px;" type="submit" value="THÊM MỚI" class="btn btn-primary" />
                    </div>
                </form>
                ...
                <form action="UpdateWorkingTime" onsubmit="preUpdate()">
                    ...
                    <div class="col-md-4" style="margin-top: 20px">
                        ...
                        <input style="width: 120px; height: 45px;" type="submit" value="CẬP NHẬT" class="btn btn-primary" />
                    </div>
                </form
                ...
                <form action="CreateNewWorkingTime" onsubmit="preCreate()">
                    ...
                    <div class="col-md-4" style="margin-top: 20px">
                        <input type="hidden" value="#" name="" />
                        <input style="width: 120px; height: 45px;" type="submit" value="TẠO MỚI" class="btn btn-primary" />
                    </div>
                </form>
            </div>

            <!-- Table -->
            <div class="col-md-7 table-reponsive" style="margin-top: 40px;overflow-y: auto;">

            ...
            <div id="containner" class="col-md-12">
                <div class="row clearfix">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="card">
                            <h1 style="margin-left: 10px; color: #0074ad">DANH SÁCH NGƯỜI DÙNG</h1>
                            <div class="body">
                                <div class="row clearfix">
                                        ...
                                        <tbody>
                                            <c:forEach var="user" items="${requestScope.LISTUSER}" varStatus="counter">
                                                <tr>
                                                    ...
                                                    <td style="padding-top: 25px;">${user.phone}</td>
                                                    <td style="padding-top: 25px;">${user.fullName}</td>
                                                    <c:if test="${user.roleName.equals('User')}">
                                                        <td style="padding-top: 25px;">Người dùng</td>
                                                    </c:if>
                                                    <c:if test="${!user.roleName.equals('User')}">
                                                        <td style="padding-top: 25px;">Quản trị viên</td>
                                                    </c:if>

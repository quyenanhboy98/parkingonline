    ...
    <body>
        ...
        <section class="body">
            ...
            <header class="header">
                ...
                <div class="header-right" id="profileuser" style="display: none">
                    <div id="userbox" class="userbox">
                        ...
                        <div class="dropdown-menu">
                            <ul class="list-unstyled">
                                ...
                                <li>
                                    <a role="menuitem" tabindex="-1" href="#" onclick="loadIframe('CheckCurrentBooking?phone=${user.phone}')">
                                    <!--<a role="menuitem" tabindex="-1" href="#" onclick="loadIframe('GetParkDistanceMatrix?find=Tìm hết')">-->
            ...
            <div class="box-area">
                <iframe id="loadSite" style="height: 100vh; width: 100%; margin-top: 20px;" src="map.jsp">
